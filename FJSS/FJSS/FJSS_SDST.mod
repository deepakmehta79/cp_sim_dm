...
//{gantts} gantt={<a,start[a],duration[a],start[a]+duration[a],sdst[a.job][b.job],b,start[b],duration[b],start[b]+duration[b]>|<a,b> in disjunctive:(a!=b)&&(assigned[a]*assigned[b]*edge[<a,b>]==1)};
